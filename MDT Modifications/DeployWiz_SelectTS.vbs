...
' // 
' // Update:    This script now accepts TaskSequenceID as a built-in priority for CustomSettings.ini
' // 			To use, paste this file in <MDT Installation Directory>\Templates\Distribution\Scripts,
' // 			as well as in the Scripts folder of any existing deployment shares. Make sure to
' // 			regenerate the boot media for all existing deployment shares after applying this change.
' // 
' // ***************************************************************************
